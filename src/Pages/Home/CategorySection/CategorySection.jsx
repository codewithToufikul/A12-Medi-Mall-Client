...
const CategorySection = () => {
    ...
    return (
        <div className=" flex flex-col-reverse lg:flex-row-reverse  lg:items-start md:items-center justify-between  max-w-[1440px] mt-[90px] mx-auto">
            <div className=" mt-5">
                <div>
                    <SectionHead top={'WHAT ARE YOU LOOKING FOR?'} text={'SHOP BY CATEGORIES'} />
                </div>
                <div className=" grid grid-cols-2 mx-2 md:grid-cols-3 gap-5 mt-12">
                    {
